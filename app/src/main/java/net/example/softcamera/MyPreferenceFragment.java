...
import net.example.softcamera.ui.ArraySeekBarPreference;
...
//        }
    ...
    public void onSharedPreferenceChanged(SharedPreferences prefs, String key) {
        ...
        bundle.putString("Preferences", pref.getTitle().toString());
        bundle.putBoolean("value",prefs.getBoolean(key,true));

        instance.onEvent("setting", bundle);
        instance.setUserProfile("user","trial");
        setSummary(key);
    }
