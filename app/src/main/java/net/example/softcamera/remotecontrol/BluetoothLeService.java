package net.example.softcamera.remotecontrol;
...
public class BluetoothLeService extends Service {
    ...
    public final static String ACTION_GATT_CONNECTED =
            "net.example.softcamera.Remotecontrol.ACTION_GATT_CONNECTED";
    public final static String ACTION_GATT_DISCONNECTED =
            "net.example.softcamera.Remotecontrol.ACTION_GATT_DISCONNECTED";
    public final static String ACTION_GATT_SERVICES_DISCOVERED =
            "net.example.softcamera.Remotecontrol.ACTION_GATT_SERVICES_DISCOVERED";
    public final static String ACTION_DATA_AVAILABLE =
            "net.example.softcamera.Remotecontrol.ACTION_DATA_AVAILABLE";
    public final static String ACTION_REMOTE_COMMAND =
            "net.example.softcamera.Remotecontrol.COMMAND";
    public final static String ACTION_SENSOR_VALUE =
            "net.example.softcamera.Remotecontrol.SENSOR";
    public final static String SENSOR_TEMPERATURE =
            "net.example.softcamera.Remotecontrol.TEMPERATURE";
    public final static String SENSOR_DEPTH =
            "net.example.softcamera.Remotecontrol.DEPTH";
    public final static String EXTRA_DATA =
            "net.example.softcamera.Remotecontrol.EXTRA_DATA";
