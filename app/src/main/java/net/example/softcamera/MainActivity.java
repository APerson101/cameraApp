...
import net.example.softcamera.remotecontrol.BluetoothRemoteControl;
import net.example.softcamera.ui.FolderChooserDialog;
import net.example.softcamera.ui.MainUI;
import net.example.softcamera.ui.ManualSeekbars;
...
public class MainActivity extends Activity {
    ...
    static private final String ACTION_SHORTCUT_CAMERA = "net.example.softcamera.SHORTCUT_CAMERA";
    static private final String ACTION_SHORTCUT_SELFIE = "net.example.softcamera.SHORTCUT_SELFIE";
    static private final String ACTION_SHORTCUT_VIDEO = "net.example.softcamera.SHORTCUT_VIDEO";
    static private final String ACTION_SHORTCUT_GALLERY = "net.example.softcamera.SHORTCUT_GALLERY";
    static private final String ACTION_SHORTCUT_SETTINGS = "net.example.softcamera.SHORTCUT_SETTINGS";
